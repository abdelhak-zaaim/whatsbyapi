...
from whatsbyapi.types.base_update import BaseUserUpdate  # noqa
from whatsbyapi.types.others import (
...
class FlowRequest:
    ...
    def has_error(self) -> bool:
        ...
        whatsbyapi will acknowledge the error and ignore the response from the callback. The callback still be called.
        """
        return any(
    ...
    def is_health_check(self) -> bool:
        ...
        whatsbyapi will not call the callback and will return a health check response.
        """
...
class FlowResponse:
    ...
    Example:
        ...
        >>> from whatsbyapi import WhatsApp
        >>> from whatsbyapi.types.flows import FlowResponse
...
class FlowRequestCannotBeDecrypted(FlowResponseError):
    ...
    - This error is returned automatically by whatsbyapi when the request cannot be decrypted.
...
class FlowTokenNoLongerValid(FlowResponseError):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import FlowTokenNoLongerValid
...
class FlowDetails:
    ...
    def publish(self) -> bool:
        ...
        Update the status of this flow to ``FlowStatus.PUBLISHED``.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.publish_flow`.
    ...
    def delete(self) -> bool:
        ...
        When the flow is in ``FlowStatus.DRAFT`` status, you can delete it.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.delete_flow`.
    ...
    def deprecate(self) -> bool:
        ...
        When the flow is in ``FlowStatus.PUBLISHED`` status, you can only deprecate it.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.deprecate_flow`.
    ...
    def get_assets(self) -> tuple[FlowAsset, ...]:
        ...
        Get all assets attached to this flow.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.get_flow_assets`.
    ...
    def update_metadata(
        ...
        Update the metadata of this flow.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.update_flow_metadata`.
    ...
    def update_json(
        ...
        Update the json of this flow.
            - A shortcut for :meth:`whatsbyapi.client.WhatsApp.update_flow_json`.
...
class DataSource:
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import DataSource
...
class ScreenData:
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import ScreenData
    ...
    def data_key(self) -> str:
        ...
        Example:
            ...
            >>> from whatsbyapi.types.flows import Screen, ScreenData, TextHeading, DataKey
            >>> screen = Screen(
            ...     id='START',
...
class Screen:
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import Screen
        >>> screen = Screen(
        ...     id='START',
        ...     title='Welcome',
...
class FormComponent(Component, abc.ABC):
    ...
    def form_ref(self) -> str:
        ...
        Example:
            ...
            >>> from whatsbyapi.types.flows import Form, TextInput
...
class TextHeading(TextComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextHeading
...
class TextSubheading(TextComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextSubheading
...
class TextBody(TextComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextBody, FontWeight
        >>> body = TextBody(
        ...     text='Body',
...
class TextCaption(TextComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextCaption, FontWeight
        >>> caption = TextCaption(
        ...     text='Caption',
...
class TextInput(TextEntryComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextInput, InputType
        >>> text_input = TextInput(
        ...     name='email',
        ...     label='Email',
...
class TextArea(TextEntryComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import TextArea
        >>> text_area = TextArea(
        ...     name='description',
        ...     label='Description',
        ...     required=True,
...
class CheckboxGroup(FormComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import CheckboxGroup, DataSource
        >>> checkbox_group = CheckboxGroup(
        ...     name='options',
        ...     data_source=[
...
class RadioButtonsGroup(FormComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import RadioButtonsGroup, DataSource
        >>> radio_buttons_group = RadioButtonsGroup(
        ...     name='options',
        ...     data_source=[
        ...         DataSource(id='1', title='Option 1'),
...
class Footer(Component):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import Footer, Action, FlowActionType, ActionNext
...
class OptIn(FormComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import OptIn
        >>> opt_in = OptIn(
        ...     name='opt_in',
...
class Dropdown(FormComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import Dropdown, DataSource
        >>> dropdown = Dropdown(
        ...     name='options',
        ...     data_source=[
        ...         DataSource(id='1', title='Option 1'),
...
class EmbeddedLink(Component):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import EmbeddedLink, Action, ActionNext
        >>> embedded_link = EmbeddedLink(
        ...     text='Sign up',
        ...     on_click_action=Action(
        ...         name=FlowActionType.NAVIGATE,
...
class DatePicker(FormComponent):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import DatePicker
        >>> date_picker = DatePicker(
        ...     name='date',
...
class Image(Component):
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import Image, ScaleType
        >>> image = Image(
...
class Action:
    ...
    Example:
        ...
        >>> from whatsbyapi.types.flows import Action, FlowActionType, ActionNext
