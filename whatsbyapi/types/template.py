...
def _get_examples_from_placeholders(
    ...
    Example:
        ...
        >>> _get_examples_from_placeholders('Hello, {Abdelhak}, today is {day}')
        ('Hello, {{1}}, today is {{2}}', ('Abdelhak', 'day'))
        >>> _get_examples_from_placeholders('Hello, (Abdelhak), today is (day)',start='(',end=')')
...
class Language(utils.StrEnum):
    ...
    >>> from whatsbyapi.types import NewTemplate
    >>> NewTemplate.Language.ENGLISH_US

    >>> from whatsbyapi.types import Template
...
class NewTemplate:
    ...
    Example:
        ...
        ...     body=NewTemp.Body('Hello {abdolhak}! Buy now and use the code {WA_IPHONE_15} to get {15%} off!'),
    ...
    class Text(NewTemplateHeaderABC):
        ...
        Example:
            ...
            >>> from whatsbyapi.types import NewTemplate
            >>> NewTemplate.Text(text='Hello, {Abdelhak}!')
    ...
    class Image(NewTemplateHeaderABC):
        ...
        Example:
            >>> from whatsbyapi.types.template import NewTemplate
    ...
    class UrlButton(NewButtonABC):
        ...
        Example:
            ...
            ...     title='Log In',
            ...     url='https://x.com/login?email={Abdelhak@example}'
            ... )
    ...
    class FlowButton(NewButtonABC):
        ...
        Example:
            >>> from whatsbyapi.types import NewTemplate, FlowActionType
...
class Template:
    ...
    class TextValue(ComponentABC):
        ...
        Example:
            >>> from whatsbyapi.types import Template
            >>> Template.TextValue(var='Abdelhak Zaaim')  # The template was created with 'Hello, {Abdelhak}!'
    ...
    class FlowButton(ComponentABC):
        ...
        Example:
            >>> from whatsbyapi.types import Template, FlowActionType
            >>> Template.FlowButton(
