...
class CallbackData:
    ...
    Base class for all callback data classes. Subclass this class to create a type-safe callback data class.
        ...
        So object like ``User(id=123, name='Abdelhak')`` will be converted to ``123:Abdelhak``.
    ...
    Example:
        ...
        >>> from whatsbyapi.types import CallbackData
        ...
        ...         Button(
        ...             title='Get user',
        ...             callback_data=UserData(id=123, name='Abdelhak', admin=True)
        ...         )
        ...     ]
        ... )
...
class CallbackButton(BaseUserUpdate, Generic[CallbackDataT]):
    ...
    Here is an example:
        ...
        >>> from whatsbyapi import WhatsApp
        >>> from whatsbyapi.types import Button, CallbackButton
        >>> wa = WhatsApp(...)
        >>> wa.send_message(
        ...     to='+2126813127**',
        ...     text='Click the button to get the user',
...
class CallbackSelection(BaseUserUpdate, Generic[CallbackDataT]):
    ...
    Here is an example:
        ...
        >>> from whatsbyapi import WhatsApp
        >>> from whatsbyapi.types import SectionList, Section, SectionRow, CallbackSelection
        >>> wa = WhatsApp(...)
        >>> wa.send_message(
        ...     to='+2126813127**',
        ...     text='Click the button to get the user',
