...
class WhatsAppCloudApi:
    ...
    def __init__(
        ...
        if session.headers.get("Authorization") is not None:
         raise ValueError(
             f"The provided session already contains an 'Authorization' header. "
             f"Please provide a session without 'Authorization' header for the WhatsApp instance with phone_id {phone_id}."
         )
        ...
        self._session.headers = {
            ...
            "User-Agent": f"whatsapi-py-zaaim/{whatsbyapi.__version__}",
        }
        self._common_keys = {
    ...
    def send_raw_request(self, method: str, endpoint: str, **kwargs) -> Any:
        ...
        - Use this method if you want to send a request that is not yet supported by whatsbyapi.
