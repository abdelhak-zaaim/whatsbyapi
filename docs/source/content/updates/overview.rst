...
The currently supported fields by whatsbyapi are:
...
.. important::
    ...
    If you register your callback URL manually (not using whatsbyapi), you need to subscribe to the fields you want to receive.
...
.. tip::
        ...
        If you do want to handle other types of updates (fields), you can use the :py:class:`~whatsbyapi.handlers.RawUpdateHandler`
        (or the :func:`~whatsbyapi.client.WhatsApp.on_raw_update` decorator) to handle them.


The supported fields are automatically handled by whatsbyapi and converted to the following types:
...
.. list-table::
   ...
   * - Type
     - Description
   * - :py:class:`~whatsbyapi.types.message.Message`
     - A message sent by a user (text, media, order, location, etc.)
   * - :py:class:`~whatsbyapi.types.callback.CallbackButton`
     - A :py:class:`~whatsbyapi.types.callback.Button` pressed by a user
   * - :py:class:`~whatsbyapi.types.callback.CallbackSelection`
     - A :py:class:`~whatsbyapi.types.callback.SectionRow` chosen by a user
   * - :py:class:`~whatsbyapi.types.flows.FlowCompletion`
     - A flow completed by a user
   * - :py:class:`~whatsbyapi.types.message_status.MessageStatus`
     - A message status update (e.g. delivered, seen, etc.)
   * - :py:class:`~whatsbyapi.types.chat_opened.ChatOpened`
...
.. list-table::
   ...
   * - Type
     - Description
   * - :py:class:`~whatsbyapi.types.template.TemplateStatus`
