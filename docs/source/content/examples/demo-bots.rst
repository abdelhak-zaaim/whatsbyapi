...
This page contains some examples of bots you can create using whatsbyapi.
...
.. code-block:: python
    ...
    import flask  # pip3 install flask
    from whatsbyapi import WhatsApp, filters, errors
    from whatsbyapi.types import Message, MessageStatus
...
.. code-block:: python
    ...
    from whatsbyapi import WhatsApp
    from whatsbyapi.types import Message
    from whatsbyapi.filters import text
...
.. code-block:: python
    ...
    from whatsbyapi import WhatsApp, filters
    from whatsbyapi.types import Message, SectionList, CallbackSelection, Section, SectionRow
...
.. code-block:: python
    ...
    import flask
    from whatsbyapi import WhatsApp
    from whatsbyapi.types import Message, ButtonUrl
