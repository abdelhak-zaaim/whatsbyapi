...
.. code-block:: bash
    ...
    pip3 install -U whatsbyapi

- **Install from source (the bleeding edge):**

.. code-block:: bash

    git clone https://github.com/abdelhak-zaaim/whatsbyapi.git
    cd whatsbyapi && pip3 install -U .

- **If you going to use the webhook features, here is shortcut to install the required dependencies:**

.. code-block:: bash

    pip3 install -U "whatsbyapi[flask]"
    pip3 install -U "whatsbyapi[fastapi]"
...
.. code-block:: bash
    ...
    pip3 install -U "whatsbyapi[cryptography]"
...
.. code-block:: python
    ...
    wa.send_message(
        ...
        text='Hi! This message sent from whatsbyapi!'
    )
...
Now you can continue to the next section and learn how to use the ``whatsbyapi`` package. here is a quick overview of the package:
